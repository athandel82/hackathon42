...
Central control component that coordinates between left and right doors. Reads door status from both sides, issues lock commands, controls the LED indicator, and publishes a combined status for external consumers.
